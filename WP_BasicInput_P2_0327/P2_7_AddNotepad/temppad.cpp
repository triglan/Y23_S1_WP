...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		{
			str[strcount % 10][count[lineNum]++] = wParam; //--- 그 외에는 문자를 문자열 맨 뒤에 붙인다.
		}
	...
	case WM_PAINT:
		...
		GetTextExtentPoint32(hdc, str[strcount % 10], count[lineNum], &size); //--- 문자열 길이 알아내기
